<?php
  ...
  define('DIR_FS_DOCUMENT_ROOT', 'D:/AppServ/www/osc/catalog/');
  define('DIR_WS_ADMIN', '/osc/catalog/admin/');
  define('DIR_FS_ADMIN', 'D:/AppServ/www/osc/catalog/admin/');
  define('DIR_WS_CATALOG', '/osc/catalog/');
  define('DIR_WS_HTTPS_CATALOG', '/osc/catalog/');
  define('DIR_FS_CATALOG', 'D:/AppServ/www/osc/catalog/');
